...
╰──────────────────┈⊷`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '> 𝐏𝐎𝐖𝐄𝐑𝐃 𝐁𝐘 𝐒𝐇𝐄𝐑𝐀-𝐌𝐃 𝐕1💐👾',
                serverMessageId: -1
            }
        };
      ...
      buttons: [
        {
          ...
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: 'ᴍɪɴɪ ꜱʜᴇʀᴀɴ-ᴍᴅ ᴠ1',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: '𝐌𝐈𝐍𝐈 𝐒𝐇𝐄𝐑𝐀-𝐌𝐃 𝐕1💐👾',
                  rows: [
    ...
    break;
                ...
                case 'winfo': {
                    ...
                    try {
                        ...
                        winfoPpUrl = 'https://files.catbox.moe/32n8gq.jpg';
                    }
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/32n8gq.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
//===============================
 ...
 // Case: add - Add a member to the group
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/32n8gq.jpg' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐇𝐄𝐑𝐀-𝐌𝐃 𝐕1💐👾
╭─────────────────────⭓
...
*ᴡᴇʟᴄᴏᴍᴇ ɪɴ 𝐒𝐇𝐄𝐑𝐀-𝐌𝐃 𝐕1 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐁𝐎𝐓💐👾💐💗*
